...
/**
 * This class runs the Ford-Fulkerson algorithm on a FlowNetwork
 * {@link flow.maxFlow.FlowNetwork FlowNetwork}
 *
 */
public class FordFulkerson {
	 ...
	 * and the set of vertices that consist this path are mapped to the edges that
	 * connect
